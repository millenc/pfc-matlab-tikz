...
plot(x_low,arrayfun(@temperature.low,x_low),'k-',x_medium,arrayfun(@temperature.medium,x_medium),'k-',x_high,arrayfun(@temperature.high,x_high),'k-','LineWidth',lw,'MarkerSize',msz);
